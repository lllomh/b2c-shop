...
class UpgradeLogic extends Model
{
    ...
    function  __construct() {
        ...
        $this->service_url = "http://service.xmshop.online/index.php?m=Home&c=Index&a=checkVersionTp5";
        //$this->service_url = "http://service.xmshop.online/index.php?m=Home&c=Index&a=checkVersionTp52";
    ...
    */
    public  function checkVersion() { 
        ...
        $url = $this->service_url."&v=".$this->curent_version;  // http://service.xmshop.online/index.php?m=Home&c=Index&a=checkVersionTp5&v=v2.0.0
    ...
    public  function UpgradeLog($to_key_num){
        ...
        $vaules = array(                
         ...
         $url = "http://service.xmshop.online/index.php?m=Home&c=Index&a=upgradeLog&".http_build_query($vaules);
