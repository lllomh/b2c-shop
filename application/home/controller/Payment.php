...
class Payment extends Base {
    ...
    public function  __construct() {   
        ...
        if(empty($this->pay_code))
            exit('pay_code 不能为空');
        // 导入具体的支付类文件                
        include_once  "plugins/payment/{$this->pay_code}/{$this->pay_code}.class.php"; // D:\wamp\www\svn_xms\www\plugins\payment\alipay\alipayPayment.class.php                       
    ...
    // 页面跳转 // #index.php/Home/Payment/returnUrl
