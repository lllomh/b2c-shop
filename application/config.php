...
*/ 
    ...
    // 密码加密串
    'AUTH_CODE' => "xms", //安装完毕之后不要改变，否则所有密码都会出错
    ...
    /**假设这个访问地址是 www.xms.cn/home/goods/goodsInfo/id/1.html 
    ...
    ['mca'=>'home_Goods_ajaxComment','p'=>['goods_id','commentType','p']],  // 缓存评论静态页面 http://www.xms2.0.com/index.php?m=Home&c=Goods&a=ajaxComment&goods_id=142&commentType=1&p=1
    ['mca'=>'home_Goods_ajax_consult','p'=>['goods_id','consult_type','p']],  // 缓存咨询静态页面 http://www.xms2.0.com/index.php?m=Home&c=Goods&a=ajax_consult&goods_id=142&consult_type=0&p=2
    ],    
];
