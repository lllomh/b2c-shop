<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:38:"./template/pc/rainbow/index\index.html";i:1511933108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>首页-<?php echo $xms_config['shop_info_store_title']; ?></title>
    <meta name="keywords" content="<?php echo $xms_config['shop_info_store_keyword']; ?>"/>
    <meta name="description" content="<?php echo $xms_config['shop_info_store_desc']; ?>"/>
    ...
    <div class="xms-tm-hander p">
        ...
        <div class="nav-middan-z p">
            <div class="header w1224 p">
                <div class="ecsc-logo">
                    <a href="<?php echo U('Index/index'); ?>" class="logo"> <img src="<?php echo $xms_config['shop_info_store_logo']; ?>"></a>
                </div>
                <!--搜索-s-->
                <div class="ecsc-search">
                    ...
                    <div class="keyword">
                        <ul>
                            <?php if(is_array($xms_config['hot_keywords']) || $xms_config['hot_keywords'] instanceof \think\Collection || $xms_config['hot_keywords'] instanceof \think\Paginator): if( count($xms_config['hot_keywords'])==0 ) : echo "" ;else: foreach($xms_config['hot_keywords'] as $k=>$wd): ?>
                                <li>
                                    ...
                                    <div class="cata-nav-left">
                                        <div class="subitems">
                                            ...
                                            <div class="advertisement_down">
                                                <ul>                                                
                                                    <?php $pid =14;$ad_position = M("ad_position")->cache(true,xms_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1511931600 and end_time > 1511931600 ")->order("orderby desc")->cache(true,xms_CACHE_TIME)->limit("1")->select();
...
foreach($result as $key=>$v3):       
    ...
    ?>
                                    ...
                                    <div class="cata-nav-rigth">
                                        <?php $pid =51;$ad_position = M("ad_position")->cache(true,xms_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1511931600 and end_time > 1511931600 ")->order("orderby desc")->cache(true,xms_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    <div id="myCarousel" class="carousel slide p header-tp" data-ride="carousel">
        ...
        <div class="carousel-inner">
        	<?php $adk = '1'; $pid =2;$ad_position = M("ad_position")->cache(true,xms_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1511931600 and end_time > 1511931600 ")->order("orderby desc")->cache(true,xms_CACHE_TIME)->limit("5")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v1):       
    ...
    ?>
        ...
        <div class="adcertiserment_head">
            <div class="w1224">
                <ul>
                    <?php $pid =52;$ad_position = M("ad_position")->cache(true,xms_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1511931600 and end_time > 1511931600 ")->order("orderby desc")->cache(true,xms_CACHE_TIME)->limit("2")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    <div class="adv3 p">
        <div class="w1224">
            <ul>
                <?php $pid =53;$ad_position = M("ad_position")->cache(true,xms_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1511931600 and end_time > 1511931600 ")->order("orderby desc")->cache(true,xms_CACHE_TIME)->limit("3")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    <div class="adver_line">
        <div class="w1224">
            <?php $pid =3;$ad_position = M("ad_position")->cache(true,xms_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1511931600 and end_time > 1511931600 ")->order("orderby desc")->cache(true,xms_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
        ...
        <div class="layer-floor " id="floor<?php echo $k+1; ?>">
            ...
            <div class="main_layer p">
                <div class="hoste_le">  
                   ...
                   $pid =$adk_arr[$v[id]];$ad_position = M("ad_position")->cache(true,xms_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1511931600 and end_time > 1511931600 ")->order("orderby desc")->cache(true,xms_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
<!--------楼层-结束-------------->
    ...
    <div class="foot-alone">
            ...
            <div class="w1224">
                <div class="sum_main">
                    ...
                    <dl class="foot-con continue">
                        <dt>联系我们</dt>
                        <dd>
                            <span class="cellphone_con"><?php echo $xms_config['shop_info_phone']; ?></span>
                            <span class="time_con">周一至周日8:00-18:00</span>
                            <span class="cost_con">（仅收市话费）</span>
                            <a class="software_con" href="tencent://message/?uin=<?php echo $xms_config['shop_info_qq2']; ?>&amp;Site=xms商城&amp;Menu=yes" target="_blank">
        ...
        <div class="foot-bottom">
            <p>Copyright © 2016-2025 xms商城 版权所有 保留一切权利 备案号:<?php echo $xms_config['shop_info_record_no']; ?>号</p>
        </div>
    </div>
    <!--侧边栏-s-->
